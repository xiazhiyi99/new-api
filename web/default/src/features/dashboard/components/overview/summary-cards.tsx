  ...
  return (
    <div className='bg-card overflow-hidden rounded-2xl border shadow-xs'>
      <div className='grid xl:grid-cols-[minmax(0,1fr)_19rem]'>
        ...
        <div className='flex flex-col justify-between gap-3 border-t bg-[color-mix(in_oklch,var(--primary)_8%,var(--background))] p-3 sm:gap-4 sm:p-5 xl:border-t-0 xl:border-l'>
