...
function SetupGuideBackdrop(props: { compact?: boolean }) {
  return (
    <>
      <div
        className={cn(
          // Flat single-hue light-blue wash — previously blended three
          // different accent hues into a gradient that read as blue-green.
          'pointer-events-none absolute inset-0 bg-[color-mix(in_oklch,var(--primary)_9%,var(--card))] dark:opacity-60',
          props.compact
