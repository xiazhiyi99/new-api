...
export function Features(_props: FeaturesProps) {
  ...
  const features = [
    ...
    },
    {
      ...
      span: 'md:col-span-1',
      icon: <Shield className='size-4 text-sky-400' />,
      visual: (
        <div className='mt-4 flex items-center justify-center'>
          <div className='relative'>
            <div className='flex size-16 items-center justify-center rounded-2xl border border-sky-500/20 bg-sky-500/5'>
              <Shield
                className='size-7 text-sky-500/70'
                strokeWidth={1.5}
              />
            </div>
            <div className='absolute -top-1 -right-1 flex size-4 items-center justify-center rounded-full bg-sky-500'>
              <svg
